...
<body>
    ...
    <section class="games">
    <div class="card">
        <a href="https://clashroyale.com/" target="_blank">
            <img src="images/clashroyale.png" alt="Clash Royale" class="thumbnails">
        </a>
    ...
    <div class="card">
        <a href="https://www.ea.com/games/plants-vs-zombies" target="_blank">
            <img src="images/PvZ.png" alt="Plants vs Zombies" class="thumbnails">
        </a>
    ...
    <div class="card">
        <a href="https://www.leagueoflegends.com/" target="_blank">
            <img src="images/LoL.png" alt="League of Legends" class="thumbnails">
        </a>
    ...
    <div class="card">
        <a href="https://supercell.com/en/games/brawlstars/" target="_blank">
            <img src="images/brawlStars.png" alt="Brawl Stars" class="thumbnails">
        </a>
    ...
    <div class="card">
        <a href="https://supercell.com/en/games/clashofclans/" target="_blank">
            <img src="images/ClashofClans.png" alt="Clash of Clans" class="thumbnails">
        </a>
    ...
    <div class="card">
        <a href="https://www.ndemiccreations.com/en/22-plague-inc" target="_blank">
            <img src="images/Plague.png" alt="Plague Inc" class="thumbnails">
        </a>
